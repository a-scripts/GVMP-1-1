...
namespace VMP_CNR
{
    ...
    public static class Price
    {
        public static class License
        {
            public static int Car = 9000;
            public static int Bike = 7000;
            public static int PlaneA = 20000;
            public static int PlaneB = 45000;
            public static int Gun = 50000;
            public static int Biz = 25000;
            public static int Lkw = 15000;
            public static int Boot = 7000;
            public static int Transfer = 15000;
        }
