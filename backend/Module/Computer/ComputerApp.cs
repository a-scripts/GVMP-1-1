...
namespace VMP_CNR.Module.Computer
{
    ...
    public class ComputerAppPlayerObject
    {
        ...
        public ComputerAppPlayerObject(ComputerApp computerApp)
        {
            Id = computerApp.Id;
        ...
        public ComputerAppPlayerObject(uint id, string appName, string displayName, string iconPath)
        {
            Id = id;
            AppName = appName;
