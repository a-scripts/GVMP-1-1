...
namespace VMP_CNR.Module.JobFactions.Carsell
{
    ...
    {
        [RemoteEvent]
        public void JobCarsellSetCarColor(Player player, string returnstring)
        {
        ...
        [RemoteEvent]
        public void JobCarsellCreateOrder(Player player, string returnstring)
        {
            DbPlayer dbPlayer = player.GetPlayer();
            if (dbPlayer == null || !dbPlayer.IsValid()) return;
        ...
        [RemoteEvent]
        public void JobCarsellFinishOrder(Player player, string returnstring)
        {
            DbPlayer dbPlayer = player.GetPlayer();
            if (dbPlayer == null || !dbPlayer.IsValid()) return;
        ...
        [RemoteEvent]
        public void JobCarsellSetPriceAttach(Player player, string returnstring)
        {
            DbPlayer dbPlayer = player.GetPlayer();
            if (dbPlayer == null || !dbPlayer.IsValid()) return;
        ...
        [RemoteEvent]
        public void JobCarsellCustomerBuy(Player player, string returnstring)
        {
            DbPlayer dbPlayer = player.GetPlayer();
            if (dbPlayer == null || !dbPlayer.IsValid()) return;
