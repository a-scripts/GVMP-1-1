...
namespace VMP_CNR.Module.Players.Seat
{
    public class PlayerSeatModule : SqlModule<PlayerSeatModule, PlayerSeat, int>
    {
        ...
        [RemoteEvent]
        public void Interact(Player player, int model, Vector3 position, Vector3 rotation, NetHandle seatNetHandle)
        {
        ...
        {
            if (dbPlayer.CurrentSeat != 0 && dbPlayer.CurrentSeatIndex != 0)
            {
