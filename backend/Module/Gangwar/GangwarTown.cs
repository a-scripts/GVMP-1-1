...
namespace VMP_CNR.Module.Gangwar
{
    ...
    public static class GangwarTownFunctions
    {
        ...
        public static void StartFight(this GangwarTown gangwarTown, Team attackerTeam, Team defenderTeam)
        {
            ...
            gangwarTown.triggerPlayerOfTownMembers("initializeGangwar", attackerTeam.ShortName, defenderTeam.ShortName, attackerTeam.Id, defenderTeam.Id,
        ...
        {
            gangwarTown.triggerPlayerOfAll("finishGangwar");
            ...
            {
                if (item.Value == null || !item.Value.IsValid()) continue;
        ...
        public static void triggerPlayerOfAll(this GangwarTown gangwarTown, string eventName, params object[] args)
        {
        ...
        public static void triggerPlayerOfTownMembers(this GangwarTown gangwarTown, string eventName, params object[] args)
        {
            foreach (DbPlayer dbPlayer in gangwarTown.Visitors)
            {
                //dimensions check?
        ...
        public static void IncreasePoints(this GangwarTown gangwarTown, int defender, int attacker)
        {
            ...
            gangwarTown.triggerPlayerOfTownMembers("updateGangwarScore", gangwarTown.AttackerPoints, gangwarTown.DefenderPoints);
        }
