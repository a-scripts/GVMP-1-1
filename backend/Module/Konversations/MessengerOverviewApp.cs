...
namespace VMP_CNR.Module.Konversations
{
    public class MessengerOverviewApp : SimpleApp
    {
        ...
        [RemoteEvent]
        public void deletePhoneChat(Player p_Player, uint p_ConversationID)
        {
        ...
        [RemoteEvent]
        public void sendPhoneMessage(Player p_Player, string p_Receivere, string p_Message)
        {
            ...
            uint p_Receiver = uint.Parse(p_Receivere);
            ...
            PlayerKonversationMessage l_NewMessage = new PlayerKonversationMessage();
        ...
        [RemoteEvent]
        public void responsePhoneMessage(Player p_Player, uint p_MsgPartner, string p_Answer)
        {
            DbPlayer l_DbPlayer = p_Player.GetPlayer();
