...
namespace VMP_CNR.Module.Items.Scripts
{
    public static partial class ItemScript
    {
        ...
        public static async Task<bool> VehicleClaw(DbPlayer iPlayer, ItemModel ItemData)
        {
            ...
            if ((iPlayer.TeamId == (int)teams.TEAM_POLICE && isStaatClaw && iPlayer.IsInDuty()) || (iPlayer.Team.IsGangsters() && !isStaatClaw))
            {
                ...
                {
                    await DoVehicleClaw(iPlayer, sxVehicle, isStaatClaw, "");
                    return true;
                }
            }
            return false;
