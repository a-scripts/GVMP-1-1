...
namespace VMP_CNR.Module.Items.Scripts
{
    ...
    {
        public static async Task<bool> BarriereArrow(DbPlayer iPlayer, ItemModel ItemData)
        {
            ...
            PoliceObjectModule.Instance.Add(1867879106, iPlayer.Player, ItemData, false);
