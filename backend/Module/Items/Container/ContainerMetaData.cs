...
namespace VMP_CNR.Module.Items
{
    ...
    public static class ContainerMetaData
    {
        public static Dictionary<ContainerTypes, ContainerData> metaDataDic = new Dictionary<ContainerTypes, ContainerData>()
        {
            ...
            {ContainerTypes.METHLABORATORYINPUT, new ContainerData() { DefaultSlots = 9, DefaultWeight = 40000, DatabaseTable = "container_methlaboratory_input", InventoryName = "Methlabor Rohstoffe" } },
            {ContainerTypes.METHLABORATORYOUTPUT, new ContainerData() { DefaultSlots = 12, DefaultWeight = 240000, DatabaseTable = "container_methlaboratory_output", InventoryName = "Methlabor Endprodukt" } },
            ...
            {ContainerTypes.WEAPONLABORATORYINPUT, new ContainerData() { DefaultSlots = 9, DefaultWeight = 40000, DatabaseTable = "container_weaponlaboratory_input", InventoryName = "Waffenlabor Rohstoffe" } },
            {ContainerTypes.WEAPONLABORATORYOUTPUT, new ContainerData() { DefaultSlots = 12, DefaultWeight = 240000, DatabaseTable = "container_weaponlaboratory_output", InventoryName = "Waffenlabor Endprodukt" } },
            {ContainerTypes.WORKSTATIONINPUT, new ContainerData() { DefaultSlots = 36, DefaultWeight = 2000000, DatabaseTable = "container_workstation_input", InventoryName = "Rohstoff" } },
            {ContainerTypes.WORKSTATIONOUTPUT, new ContainerData() { DefaultSlots = 36, DefaultWeight = 2000000, DatabaseTable = "container_workstation_output", InventoryName = "Endprodukt" } },
            ...
            {ContainerTypes.CANNABISLABORATORYINPUT, new ContainerData() { DefaultSlots = 9, DefaultWeight = 40000, DatabaseTable = "container_cannabislaboratory_input", InventoryName = "Cannabislabor Rohstoffe" } },
            {ContainerTypes.CANNABISLABORATORYOUTPUT, new ContainerData() { DefaultSlots = 12, DefaultWeight = 240000, DatabaseTable = "container_cannabislaboratory_output", InventoryName = "Cannabislabor Endprodukt" } },
            {ContainerTypes.MINECONTAINERALU, new ContainerData() { DefaultSlots = 63, DefaultWeight = 5000000, DatabaseTable = "container_mine_alu", InventoryName = "Aluminium-Erz" } },
            {ContainerTypes.MINECONTAINERBRONCE, new ContainerData() { DefaultSlots = 63, DefaultWeight = 5000000, DatabaseTable = "container_mine_bronce", InventoryName = "Bronze-Erz" } },
            {ContainerTypes.MINECONTAINERIRON, new ContainerData() { DefaultSlots = 63, DefaultWeight = 5000000, DatabaseTable = "container_mine_iron", InventoryName = "Eisen-Erz" } },
            {ContainerTypes.MINECONTAINERZINK, new ContainerData() { DefaultSlots = 63, DefaultWeight = 5000000, DatabaseTable = "container_mine_zink", InventoryName = "Zink-Erz" } },
            ...
            {ContainerTypes.MINECONTAINERSCHMELZE, new ContainerData() { DefaultSlots = 63, DefaultWeight = 5000000, DatabaseTable = "container_mine_schmelzofen", InventoryName = "Schmelzofen" } },
            ...
            {ContainerTypes.VEHICLE2, new ContainerData() { DefaultSlots = 2, DefaultWeight = 6000, DatabaseTable = "container_vehicle_2", InventoryName = "Handschuhfach" } },
