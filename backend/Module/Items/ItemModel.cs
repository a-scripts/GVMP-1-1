...
namespace VMP_CNR.Module.Items
{
    ...
    public class ItemModel : Loadable<uint>
    {
        ...
        public ItemModel(MySqlDataReader reader) : base(reader)
        {
            ...
            AttachmentOnlyId = reader.GetInt32("attachment_only_id");
        }
        ...
        public bool CanDrugInfect()
        {
            return (Id == 1  || // Meth
                    ...
                    Id == 729 ||  // Kiste
                    Id == 553 || // Kokainblatt
                    Id == 554 || // Getrocknetes Kokainblatt
                    Id == 555 || // Kokainpaste
                    Id == 556 || // Kokain
                    Id == 557 || // Kokainpäcken
                    Id == 558 || // Gestrecktes Kokain
                    Id == 559 || // Kokain Päckchen G
                    Id == 1272 // Kokainpflanze
                );
        }
    }
}
