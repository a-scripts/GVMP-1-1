...
namespace VMP_CNR.Module.Menu
{
    public enum PlayerMenu : uint
    {
        ...
        PlanningroomWeaponCreateMenu = 297,
        NSAVehicleObersvationListMenu = 298,
        NSAWanzeMenu = 299,
        PaintballEnterMenu = 300,
        SpaceRocketControlMenu = 301,
        CreateDepotMenu = 302,
        ManageDepotMenu = 303,
        TattooLicensePaginationMenu = 304,
        BunkerDealerSellMenu = 305,
        BunkerRessourceBuyMenu = 306,
        SGJobChooseMenu = 307,
        AntiCheatTeleportMenu = 308,
        AntiCheatTeleportDetailMenu = 309,
        AirFlightJobStartMenu = 310,
        PlanningroomInfoTableMenu = 311,
        ArmoryComponentMenu = 312,
        FIBPermitMenu = 313,
        GOVComputerMenu = 314,
        InjuryMoveMenu = 315,
    }
    ...
    public class MenuManager
    {
        ...
        public static void DismissMenu(Player player, uint menuId)
        {
