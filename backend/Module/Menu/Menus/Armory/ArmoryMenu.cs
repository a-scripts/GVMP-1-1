                ...
                switch (index)
                {
                    case 1:
                        ...
                        if(back > 0)
                        {
                            ...
                            iPlayer.GiveBankMoney(back, "Rückzahlung - Dienstequipment");
                            back = 0;
                        }
                    ...
                    case 7:
                        if (Armory.ArmoryWeapons.Count <= 0)
                        {
                            iPlayer.SendNewNotification("Ihr Team hat keine Erweiterungen verfügbar!");
                            MenuManager.DismissMenu(iPlayer.Player, (int)PlayerMenu.Armory);
                            return true;
                        }
                        // Ammo
                        MenuManager.Instance.Build(PlayerMenu.ArmoryComponentMenu, iPlayer).Show(iPlayer);
                        break;
                    case 8:
