...
namespace VMP_CNR.Module.Configurations
{
    internal static class Coordinates
    {
        ...
        internal static readonly Vector3 WeaponlaboratoryInvInputPosition = new Vector3(891.748, -3196.89, -98.1962);
        internal static readonly Vector3 WeaponlaboratoryInvOutputPosition = new Vector3(883.821, -3207.65, -98.1962);
        internal static readonly Vector3 WeaponlaboratoryInvFuelPosition = new Vector3(883.907, -3211.5, -98.1962);
        internal static readonly Vector3 WeaponlaboratoryComputerPosition = new Vector3(891.702, -3211.62, -98.1998);
        internal static readonly Vector3 WeaponlaboratoryWeaponBuildMenuPosition = new Vector3(885.043, -3199.51, -98.1962);
