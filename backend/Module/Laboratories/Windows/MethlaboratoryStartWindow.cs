...
namespace VMP_CNR.Module.Laboratories.Windows
{
    public class MethlaboratoryStartWindow : Window<Func<DbPlayer, Methlaboratory, bool>>
    {
        ...
        [RemoteEvent]
        public void saveMethLabor(Player Player, float temperature, float pressure, float stirring, float amount)
        {
        ...
        [RemoteEvent]
        public void toggleMethLabor(Player Player, bool result)
        {
            DbPlayer dbPlayer = Player.GetPlayer();
