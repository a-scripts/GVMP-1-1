...
namespace VMP_CNR.Module.Laboratories.Windows
{
    public class CannabislaboratoryStartWindow : Window<Func<DbPlayer, Cannabislaboratory, bool>>
    {
        ...
        [RemoteEvent]
        public void saveCannabisLabor(Player Player, float temperature, float pressure, float stirring, float amount)
        {
        ...
        [RemoteEvent]
        public void toggleCannabisLabor(Player Player, bool result)
        {
            DbPlayer dbPlayer = Player.GetPlayer();
