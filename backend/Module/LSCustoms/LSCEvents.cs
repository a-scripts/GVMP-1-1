...
namespace VMP_CNR.Module.LSCustoms
{
    ...
    {
        [RemoteEvent]
        public void SetCarColorLSC(Player player, string returnstring)
        {
        ...
        [RemoteEvent]
        public void SetCarPearlLSC(Player player, string returnstring)
        {
            Main.m_AsyncThread.AddToAsyncThread(new System.Threading.Tasks.Task(async () =>
            {
                try
        ...
        [RemoteEvent]
        public void SetCarTyreSmokeColorLSC(Player player, string returnstring)
        {
            Main.m_AsyncThread.AddToAsyncThread(new System.Threading.Tasks.Task(async () =>
            {
                try
