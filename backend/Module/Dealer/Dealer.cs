...
namespace VMP_CNR.Module.Dealer
{
    public class Dealer : Loadable<uint>
    {
        ...
        public Dealer(MySqlDataReader reader) : base(reader)
        {
            ...
            MethResource        = new DealerResource("Meth",        2500,   (uint)random.Next(230, 255),        (uint)random.Next(380, 450),    DateTime.Now);
            ...
            CannabisResource    = new DealerResource("Cannabis",    4000,   (uint)random.Next(380, 450),        0,                              DateTime.Now);
            ...
            {
                MethResource, MethCristallResource, DiamondResource, GoldResource, WeaponResource, CannabisResource, CocainResource
            };
