            ...
            public bool OnSelect(int index, DbPlayer dbPlayer)
            {
                ...
                switch (index)
                {
                    ...
                    case 1: // Meth
                        ...
                        if((l_Dealer.DealerSoldAmount + (l_MethPrice)) > DealerModule.Dealer5MinSellCap)
                        {
                            dbPlayer.SendNewNotification($"Ich kann aktuell nicht so viel ankaufen...!");
                            break;
                        }

                        dbPlayer.Container.RemoveItem(DealerModule.Instance.MethItemId, (int)l_MethPrice);
                        ...
                        l_Dealer.DealerSoldAmount += Convert.ToInt32(l_MethPrice);
                    ...
                    case 2: // Kiste Meth
                        ...
                        if ((l_Dealer.DealerSoldAmount + (l_PureMethPrice)) > DealerModule.Dealer5MinSellCap)
                        {
                            dbPlayer.SendNewNotification($"Ich kann aktuell nicht so viel ankaufen...!");
                            break;
                        }

                        l_Dealer.DealerSoldAmount += Convert.ToInt32(l_PureMethPrice);
                    ...
                    case 6: // Juwelen
                        ...
                        break;
                    case 7: // Paket Kokain
                        l_PricePerPureMeth = l_Dealer.CocainResource.Price;
                        xitem = dbPlayer.Container.GetItemById(557);
                        ...
                        l_PureMethPrice = Convert.ToInt32(l_PricePerPureMeth * cocainAmount);
                        l_PureMethFBank = Convert.ToInt32(l_PureMethPrice * 0.05f);
                        l_PlayerPureMethPrice = Convert.ToInt32(l_PureMethPrice * 0.95f);
