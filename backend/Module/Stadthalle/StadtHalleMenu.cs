                ...
                else if (index == 2)
                {
                    ...
                    else
                    {
                        ...
                        ComponentManager.Get<TextInputBoxWindow>().Show()(dbPlayer, new TextInputBoxWindowObject() { Title = $"Namensänderung beantragen | Kosten: ${kosten}", Callback = "NameChange",
                            ...
                            "Bei erfolgreicher Namensänderung wirst du automatisch vom Server getrennt. Vergiss nicht deinen neuen Namen in den GVRP-Launcher einzutragen! " +
