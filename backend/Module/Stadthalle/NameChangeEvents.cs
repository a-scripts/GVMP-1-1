...
namespace VMP_CNR.Module.Stadthalle
{
    public class NameChangeEvents : Script
    {
        ...
        [RemoteEvent]
        public void NameChange(GTANetworkAPI.Player player, string returnString)
        {
        ...
        [RemoteEvent]
        public void NameChangeMarryConfirm(GTANetworkAPI.Player p_Player, string p_InvitingPersonName, string p_CasinoDeviceId)
        {
        ...
        /*
        [RemoteEvent]
        public void DivorceConfirm(Player p_Player, string p_InvitingPersonName, string p_CasinoDeviceId)
        {
            DbPlayer dbPlayer = p_Player.GetPlayer();
            if (dbPlayer == null || !dbPlayer.IsValid())
            {
