...
namespace VMP_CNR.Module.Stadthalle
{
    public class StadthalleModule : Module<StadthalleModule>
    {
        ...
        public override void OnPlayerLoadData(DbPlayer dbPlayer, MySqlDataReader reader)
        {
            ...
            Console.WriteLine("StadthalleModule");
    ...
    public class StadthalleEvents : Script
    {
        ...
        [RemoteEvent]
        public void changePhoneNumberRandom(Player player, string returnString)
        {
        ...
        [RemoteEvent]
        public void changePhoneNumber(Player player, string returnString)
        {
            var dbPlayer = player.GetPlayer();
            if (dbPlayer == null || !dbPlayer.IsValid()) return;
