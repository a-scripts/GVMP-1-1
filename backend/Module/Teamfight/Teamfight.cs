        ...
        public static void GiveWPN(DbPlayer dbPlayer)
        {
            try
            {
                Main.m_AsyncThread.AddToAsyncThread(new Task(async () => {
                    ...
                    dbPlayer.GiveServerWeapon(WeaponHash.Assaultrifle, 0);
                    dbPlayer.GiveServerWeapon(WeaponHash.Advancedrifle, 0);
                    ...
                    dbPlayer.Player.TriggerEvent("stopScreenEffect", "DeathFailMPIn"); //Fix DeathScreen GW after Death
                }));
