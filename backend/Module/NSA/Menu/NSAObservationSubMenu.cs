            ...
            public bool OnSelect(int index, DbPlayer iPlayer)
            {
                ...
                switch (index)
                {
                    ...
                    case 2:
                        ...
                        return true;
                    case 3:
                        Module.Menu.MenuManager.Instance.Build(VMP_CNR.Module.Menu.PlayerMenu.NSABankMenu, iPlayer).Show(iPlayer);
                        return false;
                    case 4:
                        Module.Menu.MenuManager.Instance.Build(VMP_CNR.Module.Menu.PlayerMenu.NSAVehicleObersvationListMenu, iPlayer).Show(iPlayer);
                        return false;
                    case 5:
