...
using System.Linq;
using System.Text;
using VMP_CNR.Module.Computer.Apps.PoliceAktenSearchApp;
using VMP_CNR.Module.Players;
using VMP_CNR.Module.Players.Db;
using static VMP_CNR.Module.Computer.Apps.PoliceAktenSearchApp.PoliceAddAktenApp;
using static VMP_CNR.Module.Computer.Apps.PoliceAktenSearchApp.PoliceOverviewApp;

namespace VMP_CNR.Module.Crime.PoliceAkten
{
    public sealed class PoliceAktenModule : SqlModule<PoliceAktenModule, PoliceAkte, uint>
    {
        ...
        public List<ResponseAkteJson> GetPlayerPlayerJsonAkten(DbPlayer dbPlayer)
        {
