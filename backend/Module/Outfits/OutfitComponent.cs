...
namespace VMP_CNR.Module.Outfits
{
    public class OutfitComponent : Loadable<uint>
    {
        ...
        public OutfitComponent(MySqlDataReader reader) : base(reader)
        {
            ...
            ClothModule.Instance.Add(OutfitsModule.Instance.GetPropValue(Id), new Cloth(OutfitsModule.Instance.GetPropValue(Id), "Generated", Slot, Component, Texture, new HashSet<uint>() { 0 }, 0, 2, 0, false));
        }
