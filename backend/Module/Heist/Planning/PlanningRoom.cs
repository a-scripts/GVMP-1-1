                    ...
                    if (BasementMechanicLevel == 1 && BasementHackerLevel == 1 && BasementWeaponsLevel == 1 && BasementWardrobeLevel == 1)
                    {
                        if (KellerPreQuestMarker == null && KellerHeistQuestMarker == null)
                        {
                            NAPI.Task.Run(() =>
                            {
                                ...
                                KellerHeistQuestMarker = Markers.Create(1, PlanningModule.Instance.PlanningroomHeistInfoLocation.Add(new Vector3(0, 0, -1f)), new Vector3(0, 0, 0), new Vector3(0, 0, 0), 1.0f, 50, 255, 255, 255, TeamId, true);
                            });
                        }
                    }
                }
