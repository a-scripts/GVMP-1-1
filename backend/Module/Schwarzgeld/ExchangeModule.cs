...
namespace VMP_CNR.Module.Schwarzgeld
{
    public class ExchangeModule : Module<ExchangeModule>
    {
        ...
        public void StartExchange(DbPlayer dbPlayer)
        {
            ...
            if (dbPlayer.Attachments.ContainsKey((int)Attachment.BOX))
            {
            ...
            AttachmentModule.Instance.AddAttachment(dbPlayer, (int)Attachment.BOX);
        ...
        public void LoadVehicle(DbPlayer dbPlayer)
        {
            ...
            int schwarzgeld = JobVehicle.entity.GetData<int>("schwarzgeldLoadout");
            ...
            // Remove attachments
            AttachmentModule.Instance.RemoveAttachment(dbPlayer, (int)Attachment.BOX);
