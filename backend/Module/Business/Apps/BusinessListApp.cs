    ...
    public class BusinessListApp : SimpleApp
    {
        ...
        public void SendBusinessMembers(DbPlayer dbPlayer)
        {
            ...
            foreach (var member in business.GetMembers().ToList())
            {
                ...
                int handyNumber = (int)currentDbPlayer.handy[0];
        ...
        [RemoteEvent]
        public void requestBusinessMembers(Player player)
        {
        ...
        [RemoteEvent]
        public void requestBusinessMOTD(Player player)
        {
            var dbPlayer = player.GetPlayer();
            if (dbPlayer == null || !dbPlayer.IsValid() || !dbPlayer.IsMemberOfBusiness()) return;
        ...
        [RemoteEvent]
        public void leaveBusiness(Player p_Player)
        {
            ...
            l_DbPlayer.ActiveBusiness = null;
            l_DbPlayer.BusinessMembership = null;
            l_DbPlayer.UpdateApps();
        }

        [RemoteEvent]
        public void saveBusinessMOTD(Player p_Player, string motd)
        {
            DbPlayer l_DbPlayer = p_Player.GetPlayer();
            if (l_DbPlayer == null || !l_DbPlayer.IsValid() || !l_DbPlayer.IsMemberOfBusiness())
                return;
        ...
        [RemoteEvent]
        public void kickBusinessMember(Player p_Player, int p_PlayerID)
        {
            Main.m_AsyncThread.AddToAsyncThread(new System.Threading.Tasks.Task(() =>
            {
                ...
                kickedPlayer.ActiveBusiness = null;
                kickedPlayer.BusinessMembership = null;
                kickedPlayer.UpdateApps();
            }));
        }

        [RemoteEvent]
        public void addPlayerToBusiness(Player p_Player, string p_Name)
        {
            Main.m_AsyncThread.AddToAsyncThread(new System.Threading.Tasks.Task(() =>
            {
                try
        ...
        [RemoteEvent]
        public void addBusinessMemberConfirm(Player p_Player, string p_InvitingPersonName, string p_BusinessName)
        {
            Main.m_AsyncThread.AddToAsyncThread(new System.Threading.Tasks.Task(() =>
            {
                try
