...
namespace VMP_CNR.Module.Vehicles
{
     ...
     * System.NullReferenceException: Object reference not set to an instance of an object.
        at void VMP_CNR.Module.Vehicles.VehicleFunctions.SetTeamCarGarage(SxVehicle sxVeh, bool inGarage) in C:\Users\Jefferson\source\repos\server - Kopie\server\server\Module\Vehicles\Vehicle.cs:line 38
     */
    public static class VehicleFunctions
    {
        ...
        public static void SetTeamCarGarage(this SxVehicle sxVeh, bool inGarage, int garageId = -1)
        {
            if (sxVeh == null) return;
            ...
            if (inGarage)
            {
                if(garageId != -1)
                {
                    query = $"UPDATE `fvehicles` SET inGarage = '1', fuel = '{sxVeh.fuel}', pos_x = '0', pos_y = '0', pos_z = '0', lastGarage = '{garageId}' WHERE id = '{sxVeh.databaseId}';";
                }
                else query = $"UPDATE `fvehicles` SET inGarage = '1', fuel = '{sxVeh.fuel}', pos_x = '0', pos_y = '0', pos_z = '0' WHERE id = '{sxVeh.databaseId}';";
            }
            else
            {
