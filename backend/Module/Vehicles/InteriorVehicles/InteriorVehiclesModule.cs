            ...
            if (dbPlayer.Player.IsInVehicle)
            {
                ...
                if (sxVeh.Data.Id == AirforceDataId)
                {
                    Task.Run(async () =>
                    {
                        ...
                        if (dbPlayer.Player.VehicleSeat == -1 && sxVeh.GetOccupants().ContainsKey(0) && sxVeh.GetOccupants()[0] != null && sxVeh.GetOccupants()[0].IsValid())
                        {
                            coPilot = sxVeh.GetOccupants()[0];
                        }
                        ...
                        {
                            if (sxVeh.GetOccupants().ContainsKey(0)) sxVeh.GetOccupants().Remove(0);
                ...
                case Key.E:
                    ...
                    if (dbPlayer.Player.Dimension == Dimension)
                    {
                        ...
                        else if (dbPlayer.Player.Position.DistanceTo(AirforceCockpitPos) < 1.0f)
                        {
                            ...
                            if(!sxVeh.GetOccupants().ContainsKey(-1)) // pilot
                            {
                                if (sxVeh.Visitors.Contains(dbPlayer))
                                    sxVeh.Visitors.Remove(dbPlayer);
                            ...
                            else if(!sxVeh.GetOccupants().ContainsKey(0)) // copilot
                            {
                                Task.Run(async () =>
                                {
                                    dbPlayer.DimensionType[0] = DimensionType.World;
