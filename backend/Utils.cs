...
namespace VMP_CNR
{
    public class Utils
    {
        ...
        {
            bool add = random.NextDouble() >= 0.5; //Kann das nicht raus, Chris? mit random.Next(-30,31) deckst du doch schon den ganzen Bereich ab / Ja theoretisch schon / ne eigentlich nicht
